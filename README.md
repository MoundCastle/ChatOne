# 通信服务器。
> 服务器采用分层的设计思想，分为 网络层、 服务层、 数据存储层 <br>
...
![image](https://github.com/user-attachments/assets/04936829-fc8a-4961-b906-4a86c1e703b4)
...
### muduo
1. 高性能：
+ muduo的网络设计：reactors in threads - one loop per thread，即通过一个main reactor来负责accept连接，然后该连接的I/O事件，计算任务等都在sub reactor中完成。多个连接可能被分派到多个线程中，来充分利用CPU。
