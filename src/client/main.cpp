...
int main(int argc, char **argv)
{
    ...
    {
        cerr << "connect server error!_!" << endl;
        close(clientfd);
        exit(-1);
    }
    ...
    if(readThreadNumber == 0)
    {
        ...
        readTask.detach();                               // pthread_detach 分离线程
    }
    ...
    for (;;)
    {
        ...
        case 2: // register业务
        {
            ...
            char pwd[50] = {0};
            cout << "username:";
            cin.getline(name, 50);  // 名字有空格， cin >> 读不到
            cout << "userpassword:";
            cin.getline(pwd, 50);
...
// chat:23:
